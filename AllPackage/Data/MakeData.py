...
# return i 4 dataframe, nell'  ordine S1_bkg, S1, S2_bkg, S2   
...
#%%
# funzione che normalizza il dataframe ne fa lo smoothing, e traspone
# df = il dataframe iniziale dai dati raw
# smooth = {'savgol','none'} tipo di smoothing da applicare
# norm = {'max_min', 'area', 'none'} tipo di normalizzazione da applicare
